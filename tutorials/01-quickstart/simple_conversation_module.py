...
def run(input: str, context: str = None, **kwargs) -> str:
    ...
    if "hello" in input_lower or "hi" in input_lower:
        ...
        return "I don't have access to current weather data, but I can help you find weather resources for your area."
    
    elif "python" in input_lower or "programming" in input_lower:
        return "I'd be happy to help with Python programming! What specific topic or challenge are you working on?"
    
    elif "help" in input_lower:
        return "Of course! I'm here to help. Could you tell me more about what you need assistance with?"
    
    else:
        # Default helpful response
        return f"Thank you for your message. I understand you're asking about '{input}'. How can I best help you with this?"
