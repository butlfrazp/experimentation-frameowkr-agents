...
def _answer_math_question(question: str, mode: str) -> str:
    ...
    if "2 + 2" in question or "2+2" in question:
        if mode == "concise":
            ...
            return (
                "2 + 2 = 4. This is basic addition where we combine two quantities of 2 to get 4."
            )
        else:
            return "2 + 2 equals 4."
...
def _answer_science_question(question: str, mode: str) -> str:
    ...
    if "photosynthesis" in question_lower:
        if mode == "concise":
            ...
            return (
                "Photosynthesis is the biological process by which plants, algae, and some bacteria "
...
def _answer_general_question(question: str, mode: str) -> str:
    ...
    if mode == "concise":
        ...
        return (
            f"Thank you for your question: '{question}'. To provide you with the most accurate "
...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        # Summaries
        (
            "Summarize this: Artificial intelligence is transforming many industries. It helps automate tasks and provides insights.",
            {"mode": "detailed"},
        ),
