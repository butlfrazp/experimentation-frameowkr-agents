...
def load_nested_evaluators_method2():
    ...
    try:
        ...
        from custom_evaluators.advanced.evaluators import (
            AdvancedCoherenceEvaluator,
            AdvancedQualityEvaluator,
        )
        from custom_evaluators.basic.evaluators import (
            BasicCompletenessEvaluator,
            BasicLengthEvaluator,
        )
...
def load_nested_evaluators_method3():
    ...
    try:
        ...
        basic_spec = importlib.util.spec_from_file_location(
            "basic_evaluators", current_dir / "custom_evaluators" / "basic" / "evaluators.py"
        )
        ...
        advanced_spec = importlib.util.spec_from_file_location(
            "advanced_evaluators", current_dir / "custom_evaluators" / "advanced" / "evaluators.py"
        )
